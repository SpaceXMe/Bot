...
global.owner = [
  ['6282225201437'],
  ['6285869153641'],
  ['6282225201437', 'ItzBgz', 'spacebyte@gmail.com', true]
] // Put your number here
global.mods = ['6282225201437'] // Moderator
global.prems = ['6282225201437'] // Premium
...
global.APIKeys = { // APIKey Here
  ...
  'https://api.lolhuman.xyz': 'DannKristii',
  'https://api.itsrose.life': 'Rk-SpaceBlitz',
  'https://api.neoxr.my.id': 'SpaceBlitz',
  'https://api.caliph.biz.id': 'caliphkey',
  'https://api.betabotz.org': 'DannKristi',
  'https://xzn.wtf': 'bgzz'
}
...
if (stickerpack.spackname == '') {
  var sticker_name = '© Space'
  var sticker_author = 'Community'
} else {
...
// Apikey
global.rose = 'Rk-SpaceBlitz'
global.lolhuman = 'DannKristii'
global.caliph = 'caliphkey'
global.lann = 'DannKristi'
global.openaiKey = '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'

// Database
global.version = 'BETA 2.5'
global.session = 'spaceXsessions'
global.gcbot = 'https://chat.whatsapp.com/HaLMYcECRO31ikNKGVRJEP'
global.instagram = 'https://instagram.com/itzmebgz'
global.namebot = '𝐴𝑘𝑖𝑟𝑎 𝑆𝑝𝑎𝑐𝑒'
global.thumb = 'https://telegra.ph/file/f695766968ec96384b9bc.jpg'
global.thumbnail = 'https://telegra.ph/file/e58dccc54084e7f6ff50f.jpg'
global.forbiden = 'https://telegra.ph/file/03d74f5b177d97a7c0e7c.jpg'
global.tgif = 'https://telegra.ph/file/76ecd1ecfa6002aff7fe2.mp4'
global.tgif2 = 'https://telegra.ph/file/b76149557b2852f45c46c.mp4'
global.qris = 'https://telegra.ph/file/ce0037b2c2bb2ded15e40.jpg'
global.nomorown = '6282225201437'
global.sendown = '6282225201437@s.whatsapp.net'

// Sosial Media
global.sig = 'https://instagram.com/itzmebgz'
global.fake = 'https://bit.ly/space_blitz'
global.syt = 'https://youtube.com/@itzmebagz7987'
global.sgh = 'https://github.com/ItzBgaz'
global.sgc = 'https://chat.whatsapp.com/HaLMYcECRO31ikNKGVRJEP'
global.swa = 'https://wa.me/6282225201437'
global.swb = 'https://discord.gg/dannrpg' // Link Discord
global.snh = 'https://nhentai.net/g/365296/' // Link nhentai

// Pembayaran
global.pdana = '6282225101437'
global.povo = '6285869153641'
global.pgopay = '6283137550315'
global.pulsa = '082225201437'
global.pulsa2 = '085869153641'
global.psaweria = 'https://saweria.co/ItzBagz'
...
global.fpagedoc = '999'
global.randfsize = ['0', '10000', '1000000', '10000000000']
...
global.ddoc = 'application/msword'
global.dppt = 'application/vnd.ms-powerpoint'
global.dxls = 'application/vnd.ms-excel'
global.dtxt = 'text/plain'
global.dodt = 'application/vnd.oasis.opendocument.text'
global.alldoc = [global.dpptx, global.ddocx, global.dxlsx, global.dpdf, global.ddoc, global.dppt, global.dxls]
...
global.wm = '© 𝑺𝒑𝒂𝒄𝒆 - 𝑴𝒖𝒍𝒕𝒊 𝑫𝒆𝒗𝒊𝒄𝒆𝒔'
global.wm2 = 'Sᴘᴀᴄᴇ Aɪ'
global.bottime = `Time: ${wktuwib} WIB`
global.botdate = `Date: ${week} ${date}\nTime: ${wktuwib} WIB`
global.titlebot = `${global.wm}`
global.packname = sticker_name
global.author = sticker_author
global.nameown = 'Itz Bagzz'
global.welcome = 'Welcome @user In The Group\n\n*@subject*\n\n@desc\n\n_*Hope you feel at home...*_\n'
...
// Fake
global.bodi = ["Tetaplah Mencerna Makanan", "Hiduplah Seperti Larry", "Sewa Bot? Chat Owner", `My Name Is ${namebot}`, 'Jangan Lupa Bersyukur', `${global.wm}`]
...
global.zt = '*'
global.zc = ''
global.preff = ["⫹⫺", "◈", "➭", "ଓ", "⟆•", "⳻", "•", "↬", "⭑", "ᯬ", "◉", "»", "〆", "々", "⛥", "✗", "♪"]

// Kata-kata
global.kata = [
  "Awali harimu dengan sarapan",
  "Jika tidak ingin dimanfaatkan orang lain, maka jadilah tidak bermanfaat",
  "Jangan terlalu memikirkan perasaan orang lain jika kamu belum bisa memikirkan perasaanmu sendiri",
  "Hidup selalu berakhir dengan indah, jika belum indah maka belum berakhir",
  "Kebahagiaan tidak ditemukan dengan mencari-cari, tetapi dengan menciptakannya sendiri",
  ...
  "Hidup adalah perjalanan yang singkat, jadi nikmatilah setiap langkahnya",
  "Keberanian adalah ketika kamu menghadapi ketakutanmu, bukan ketika ketakutanmu menghadapi kamu",
  "Jangan biarkan kesalahan masa lalu menghancurkan masa depanmu. Belajarlah darinya dan terus maju",
  "Kesuksesan bukan tentang seberapa tinggi kamu melompat, tetapi seberapa sering kamu bangkit setelah jatuh",
  "Cintai dirimu sendiri terlebih dahulu, dan kemudian kamu akan mampu memberikan cinta kepada orang lain",
  "Ketika satu pintu tertutup, pintu lain akan terbuka. Tetapi kita terlalu sering melihat dan meratapi pintu yang tertutup, sehingga kita tidak melihat pintu yang terbuka di hadapan kita",
  "Jangan pernah menyerah pada impianmu. Kerja keras, keberanian, dan ketekunan akan membawamu menuju pencapaian yang luar biasa",
  "Jangan mengulangi kesalahan yang sama, karena masih banyak kesalahan yang belum dicoba",
  "Hidup bukanlah tentang menunggu badai berlalu, tetapi tentang belajar bagaimana menari di tengah hujan",
  "Ingat, hari ini adalah hari esok yang kamu khawatirkan kemarin",
  "Jangan menyerah jika kamu gagal. Ulangi kegagalanmu setiap hari hingga kamu bosan menyerah",
  "Setiap kali kamu bisa menemukan humor dalam situasi yang sulit, pasti humormu rusak",
  "Aku tidak suka kekerasan. Tapi tidak masalah kalau aku dipukul dengan keberuntungan",
  "Aku menemukan sesuatu. Bahwa masa depan tidak dapat diprediksi",
  "Masalah bisa membuat kita semakin dewasa, maka sering-seringlah bermasalah",
  "Aku tidak gagal dalam ujian. Aku baru saja menemukan 100 cara untuk melakukan kesalahan",
  "Salah satu tanda orang yang berpikir, biasanya tertawa yang paling akhir",
  "Bekerjalah sampai rekening bankmu terlihat seperti nomor telepon",
  "Kemalasan tidak lebih dari kebiasaan istirahat sebelum lelah",
  "Hidup itu seperti sebuah acara televisi yang sangat panjang tanpa remote control",
  "Mencoba adalah langkah pertama menuju kegagalan",
  ...
  "Percayalah pada dirimu sendiri. Kamu lebih kuat dari yang kamu pikirkan",
  "Kegigihan adalah kunci untuk mencapai impianmu",
  "Jangan pernah menyerah, karena biasanya yang terbaik terjadi setelah kamu merasa putus asa",
  "Hidup adalah petualangan yang indah. Nikmatilah setiap momennya",
  "Keberanian bukanlah ketiadaan rasa takut, tetapi tindakan di tengah rasa takut",
  "Kamu bisa mengubah dunia dengan tindakan-tindakan kecil yang baik",
  "Kesuksesan adalah hasil dari usaha yang tak pernah berhenti",
  "Hidup ini singkat, jangan sia-siakan waktu untuk hal-hal yang tidak berarti",
  "Tantangan adalah peluang untuk tumbuh dan berkembang"
]


// Image
global.flaa = ['https://flamingtext.com/net-fu/proxy_form.cgi?&imageoutput=true&script=water-logo&script=water-logo&fontsize=90&doScale=true&scaleWidth=800&scaleHeight=500&fontsize=100&fillTextColor=%23000&shadowGlowColor=%23000&backgroundColor=%23000&text=',
