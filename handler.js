    ...
    async handler(chatUpdate) {
        ...
        try {
            ...
            try {
                ...
                if (user) {
                    ...
                    if (!('police' in user)) user.police = false
                    ...
                    if (!isNumber(user.resetlimit)) user.resetlimit = 0
                    ...
                    if (!isNumber(user.grab)) user.grab = 0
                    if (!isNumber(user.ojek)) user.ojek = 0
                    if (!isNumber(user.ngentod)) user.ngentod = 0
                    if (!isNumber(user.koboy)) user.koboy = 0
                    ...
                    if (!isNumber(user.lastngentod)) user.lastngentod = 0
        ...
        //    const groupMetadata = (m.isGroup ? (conn.chats[m.chat].metadata || await conn.groupMetadata(m.chat)): {}) || {}
            ...
            for (let name in global.plugins) {
                ...
                if (!global.db.data.settings[this.user.jid].restrict) if (plugin.tags && plugin.tags.includes('admin')) {
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (m.chat in global.db.data.chats || m.sender in global.db.data.users) {
                        let chat = global.db.data.chats[m.chat]
                        let user = global.db.data.users[m.sender]
                        if (name != ('owner-unbanchat.js' || 'info-botstats.js') && chat && chat.isBanned) return // Except this
                    }
...
text: `Limit anda habis, silahkan beli melalui *${usedPrefix}buy limit* atau *${usedPrefix}gethadiah*\n\nLimit akan direset setiap pukul\n*12.00 WIB*\n\n${wm2}`,
contextInfo: {
externalAdReply: {
title: wm,
body: namebot,
...
renderLargerThumbnail: true
                    ...
                    if (isBans && global.db.data.users[m.sender].banned == true) {
                      this.reply(m.chat, `Kamu telah dibanned!\nUntuk membuka banned silahkan hubungi owner\n\nwa.me/${global.owner[0]}`, m)
                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            let wel = 'https://telegra.ph/file/cb25d116067c408b80fea.jpg'
                            let lea = 'https://telegra.ph/file/9de46c7eb43946a509eef.jpg'

                             this.sendMessage(id, {
                             document: require('fs').readFileSync('./thumb.doc'),
                             caption: `\n${text}\n`,
                             fileLength: fsizedoc,
                             pageCount: 999999999,
                             fileName: action === 'add' ? "YOOO WHAT'S UP" : "DON'T BACK AGAIN!",
                             mimetype: dxls,
                             contextInfo: {
  ...
  async delete(m) {
    ...
    if (chat.delete) return this.reply(m.key.remoteJid, `
...
title: namebot,
body: wm,
thumbnailUrl: forbiden,
sourceUrl: sig,
mediaType: 1,
renderLargerThumbnail: true
}}}, { quoted: m })
    let messa = {
        botAdmin: `${stick}/botAdmin.webp`,
    }[type]
    if (messa) return conn.sendFile(m.chat, messa, 'sticker.webp', '', m)
    let msgg = {
        unreg: `
Hai kak @${m.sender.split('@')[0]}!
Untuk menggunakan fitur *${namebot}*, kamu harus daftar terlebih dahulu...
 
╭─────────────•
│߷ Manual
│✎ Ketik: *#daftar nama.umur*
│✎ Contoh: *#daftar space.17*
┝━━━━━━━━━⌑
│߷ Email
│✎ Ketik: *#regmail <email kamu>*
│✎ Contoh: *#regmail space@gmail.com*
┝━━━━━━━━━⌑
│߷ OTP:
│✎ Ketik: *#regnom <nomor kamu>*
│✎ Contoh: *#regnom ${m.sender.split('@')[0]}*
╰─────────────•
...
text: msg2,
contextInfo: {
mentionedJid: conn.parseMention(msg2),
externalAdReply: {
title: namebot,
body: wm,
thumbnailUrl: forbiden,
