...
let thumb = 'https://telegra.ph/file/07246c0237db69d748199.jpg'
try {
...
//Uang
let uangm = Math.floor(Math.random() * 10) + 5
let duit = Math.floor(Math.random() * 20) + 5
let duitm = Math.floor(Math.random() * 50) + 5
let duitd = Math.floor(Math.random() * 62) + 5
let duitr = Math.floor(Math.random() * 20) + 5
let duitk = Math.floor(Math.random() * 70) + 5
//ANJAY
...
if (new Date - global.db.data.users[m.sender].lastkerja < 300000)  throw `Kamu sudah bekerja\nSaatnya istirahat selama ${msToTime(time - new Date())}`
	global.db.data.users[m.sender].bank += uangm
...
if (new Date - global.db.data.users[m.sender].lastkerja < 300000)  throw `Kamu sudah bekerja,Saatnya istirahat selama\n🕜 *${msToTime(time - new Date())}*`
	global.db.data.users[m.sender].bank += duit
global.db.data.users[m.sender].lastkerja = new Date * 1
...
if (new Date - global.db.data.users[m.sender].lastkerja < 300000)  throw `Kamu sudah bekerja,Saatnya istirahat selama\n🕜 *${msToTime(time - new Date())}*`
	global.db.data.users[m.sender].bank += duitm
global.db.data.users[m.sender].lastkerja = new Date * 1
