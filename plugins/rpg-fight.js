...
conn.level = global.db.data.users[m.sender]
  ...
  if (typeof conn.fight[m.sender] != "undefined" && conn.fight[m.sender] == true) return m.reply(`*Tidak bisa melakukan pertarungan lagi karena kamu sedang bertarung*`)
  ...
  m.reply(`*Kamu* (level ${global.db.data.users[m.sender].level})\n     VS\n*${conn.getName(lawan)}* (level ${global.db.data.users[lawan].level})\n\nSedang dalam pertarungan sengit.\n\nTunggu ${lamaPertarungan} menit lagi dan lihat siapa yg menang.`)
