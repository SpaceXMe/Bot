        ...
        case 'mythic':
            switch (jumlah) {
                ...
                case 'crate':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _mm = `${Math.floor(Math.random() * 20)}`.trim()
...
`.trim()
                ...
                case '10':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _mm1 = `${Math.floor(Math.random() * 20)}`.trim()
...
`.trim()
                ...
                case '100':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _mm2 = `${Math.floor(Math.random() * 75)}`.trim()
...
`.trim()
                ...
                case '1000':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _mm3 = `${Math.floor(Math.random() * 100)}`.trim()
                    let _mmm3 = `${Math.floor(Math.random() * 50)}`.trim()
                    let _me3 = `${Math.floor(Math.random() * 2500)}`.trim()
...
`.trim()
                ...
                case '10': 
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _mme= `${Math.floor(Math.random() * 30)}`.trim()
                    let _bbbe = `${Math.floor(Math.random() * 4)}`.trim()
                    let _mee = `${Math.floor(Math.random() * 250)}`.trim()
...
`.trim()
                ...
                case '100':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _mmk = `${Math.floor(Math.random() * 45)}`.trim()
                    let _bbbk = `${Math.floor(Math.random() * 10)}`.trim()
                    let _mek = `${Math.floor(Math.random() * 400)}`.trim()
...
`.trim()
                ...
                case '1000':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _mmo = `${Math.floor(Math.random() * 45)}`.trim()
        ...
        case 'legendary':
            switch (jumlah) {
                ...
                case 'crate':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _lm = `${Math.floor(Math.random() * 45)}`.trim()
...
`.trim()  
                ...
                case '10':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _lm1 = `${Math.floor(Math.random() * 80)}`.trim()
...
`.trim()  
                ...
                case '100':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _lm2 = `${Math.floor(Math.random() * 90)}`.trim()
                    let _le2 = `${Math.floor(Math.random() * 2000)}`.trim()
...
`.trim()  
                ...
                case '1000':
                    ...
                    if (new Date - global.db.data.users[m.sender].lastopen > 30000) {
                    let _lm3 = `${Math.floor(Math.random() * 100)}`.trim()
                    let _le3 = `${Math.floor(Math.random() * 10000)}`.trim()
...
`.trim()  
        ...
        case 'pet':
            ...
            let randpet = `${pickRandom(['Anda kurang beruntung', 'Coba buka lagi lain kali, karena ga dapet pet', 'kasian ga dapet pet', 'Mungkin lagi ga hoki dan ga dapet pet', 'wkwkkwkwke'])}`.trim()
