...
conn.level = global.db.data.users[m.sender]
  ...
  if (global.db.data.users[m.sender].kyubi == 0) return m.reply(`Kamu belum memiliki Naga Silahkan beli dulu..\n\nKetik: *${usedPrefix}petshop naga* untuk membeli naga`)
  ...
  m.reply(`*Pet Kamu* (🐉naga level ${global.db.data.users[m.sender].naga}) ⚔️menantang 🐉naganya *${conn.getName(lawan)}* (🐉naga level ${global.db.data.users[lawan].naga}) lagi berkelahi.\n\nTunggu ${lamaPertarungan} menit lagi dan lihat siapa yg menang🎮.`)
