let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    let fltr
    if (/listall/i.test(command)) fltr = split
...
handler.help = ['listall', 'listdoc', 'listmsg', 'listvideo', 'listgif', 'listaudio', 'listimg', 'liststicker']
handler.tags = ['tools']
handler.command = /^(daftar|list)(all|doc|msg|video|audio|img|stic?ker|gif)$/i
