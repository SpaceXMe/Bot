...
conn.level = global.db.data.users[m.sender]
  ...
  if (global.db.data.users[m.sender].griffin == 0) return m.reply(`Kamu belum memiliki Griffin Silahkan beli dulu..\n\nKetik: *${usedPrefix}petshop griffin* untuk membeli griffin`)
  ...
  m.reply(`*Pet Kamu* (🦚griffin level${global.db.data.users[m.sender].griffin}) ⚔️menantang 🦚griffinnya *${conn.getName(lawan)}* (🦚griffin level${global.db.data.users[lawan].griffin}) lagi berkelahi.\n\nTunggu ${lamaPertarungan} menit lagi dan lihat siapa yg menang🎮.`)
