let { currency } = require('../lib/myfunc')
            ...
            case 'money':
                if (global.db.data.users[m.sender].money >= count * 1) {
                    try {
                        ...
                        conn.reply(m.chat, `Berhasil mentransfer money sebesar\n${currency(count)}`.trim(), m)
                    } catch (e) {
                        global.db.data.users[m.sender].money += count * 1
                ...
                } else conn.reply(m.chat, `Uang kamu tidak mencukupi untuk mentransfer Money sebesar:\n${currency(count)}`.trim(), m)
                break 
            case 'bank':
                if (global.db.data.users[m.sender].bank >= count * 1) {
                    try {
                        ...
                        conn.reply(m.chat, `Berhasil mentransfer bank sebesar\n${currency(count)}`.trim(), m)
                    } catch (e) {
                        global.db.data.users[m.sender].bank += count * 1
                        m.reply('Gagal Menstransfer')
                        console.log(e)
                ...
                } else conn.reply(m.chat, `*Space Bank* kamu tidak mencukupi untuk mentransfer Bank sebesar:\n${currency(count)}`.trim(), m)
                break 
             case 'exp':
                if (global.db.data.users[m.sender].exp >= count * 1) {
                    try {
                        ...
                        conn.reply(m.chat, `Berhasil mentransfer exp sebesar\n*${count}*`.trim(), m)
                    } catch (e) {
                        global.db.data.users[m.sender].exp += count * 1
                        m.reply('Gagal Menstransfer')
                        console.log(e)
                ...
                } else conn.reply(m.chat, `Exp kamu tidak mencukupi untuk mentransfer Exp sebesar:\n${count}`.trim(), m)
                break
             case 'limit':
                if (global.db.data.users[m.sender].limit >= count * 1) {
                    try {
                        ...
                        conn.reply(m.chat, `Berhasil mentransfer limit sebesar\n*${count}*`.trim(), m)
                ...
                } else conn.reply(m.chat, `Limit kamu tidak mencukupi untuk mentransfer Limit sebesar:\n${count}`.trim(), m)
                break
                case 'kayu':
                if (global.db.data.users[m.sender].kayu >= count * 1) {
                    try {
                        ...
                        conn.reply(m.chat, `Berhasil mentransfer kayu sebesar\n*${count}*`.trim(), m)
                    } catch (e) {
                        global.db.data.users[m.sender].kayu += count * 1
                        m.reply('Gagal Menstransfer')
                        console.log(e)
                ...
                } else conn.reply(m.chat, `Kayu kamu tidak mencukupi untuk mentransfer Kayu sebesar:\n${count}`.trim(), m)
                break
                case 'gelas':
                if (global.db.data.users[m.sender].kayu >= count * 1) {
                    try {
